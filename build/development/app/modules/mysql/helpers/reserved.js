...
class Reserved {
    ...
    process(query, packets) {
        return __awaiter(this, void 0, void 0, function* () {
            let results = { "data": "", "action": "", "status": false, "is_eof": true };
    ...
    query(query, command, param, is_eof) {
        let okPacket = new ubuffer_1.default();
        okPacket.from([0x07, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00]);
        let result = { "status": true, "action": "query", "data": okPacket.data(), "is_eof": is_eof };
