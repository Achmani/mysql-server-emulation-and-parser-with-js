...
const greeting_1 = __importDefault(require("../../interface/packet/greeting"));
class GreetingPacket extends greeting_1.default {
    constructor(version) {
        super(version);
    ...
    pack(servername) {
        ...
        for (let index = 0; index < this.salt.length; index++) {
            this.salt[index] = util_1.getRandomInt(1, 123);
        }
