...
export default class UBuffer {
    ...
    alloc(n: number) {
        this.buf = Buffer.alloc(n);
        this.pos = 0;
        this.seek = 0;
        this.cap = 0;
    }

    from(v: Buffer | Array<any>) {
        this.buf = Buffer.from(v);
