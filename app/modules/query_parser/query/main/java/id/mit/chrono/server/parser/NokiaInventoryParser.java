...
import id.mit.chrono.server.obj.MapEntityObj;
...
public class NokiaInventoryParser extends BaseFileParser implements FileParser {
...
//            System.out.println("Processing: " + file);
            ...
            try {
                ...
                NokiaInventoryParser.NokiaRacopsHandler userhandler = new NokiaInventoryParser.NokiaRacopsHandler();
    ...
    public static void main(String[] args){
        ...
        new NokiaInventoryParser().parseLocal();
    }
