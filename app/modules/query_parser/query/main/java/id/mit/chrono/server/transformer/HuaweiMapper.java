...
public class HuaweiMapper extends BaseTransformerMapper {
...
////                        file.getColumnset().toLowerCase().contains(params.getNptqParams().toLowerCase()) &&
...
//            }).collect(Collectors.toList());
            ...
            // if params not found, then insert as empty source.
