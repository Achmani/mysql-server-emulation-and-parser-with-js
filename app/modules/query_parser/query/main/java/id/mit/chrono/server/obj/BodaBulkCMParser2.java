...
public class BodaBulkCMParser2 {

    public BodaBulkCMParser2() {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BodaBulkCMParser2.class);
...
//            java.util.logging.Logger.getLogger(HuaweiCMObjectParser.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            //Get parser instance
            BodaBulkCMParser2 cmParser = new BodaBulkCMParser2();
