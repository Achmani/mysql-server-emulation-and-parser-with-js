...
public class NokiaInventoryMrbtsParser extends BaseFileParser implements FileParser {
...
//            System.out.println("Processingxxx: " + file);
            ...
            try {
                ...
                NokiaInventoryMrbtsParser.NokiaRacopsHandler userhandler = new NokiaInventoryMrbtsParser.NokiaRacopsHandler();
